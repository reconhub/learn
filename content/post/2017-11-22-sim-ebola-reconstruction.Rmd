...
plot(res_full,  type = "alpha", burnin = 1000) # ancestries
plot(res_full,  type = "t_inf", burnin = 1000) # infection dates
plot(res_full,  type = "network", burnin = 1000, min_support = .05) # transmission trees
```
