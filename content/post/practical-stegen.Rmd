...
(`path_to_data`), using the function `read_xlsx()` from the *readxl* package to read data in, and saving the
...
<details>
<summary> <b>Going further</b> click on the button below to learn about <code>tapply()</code>: </summary>
