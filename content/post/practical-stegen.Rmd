...
To conclude your report you would like to include a very basic spatial overview of cases. Based on the postal codes of all individuals that had symptoms gps coordinates were generated providing each individual with a latitude and longtitude which corresponds with their household. The variables *lat* and *long* include the longitude and latitude which we will use to plot the cases using *ggplot2*.
