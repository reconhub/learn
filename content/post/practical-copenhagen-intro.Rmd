...
This tutorial is designed to be followed along in the context of an R project
folder structure:
...
Open the dataset **copenhagen_raw.csv** using the `read.csv()` command.  
...
![Browsing your dataset in R Studio](../../img/highres/copenhagen-screenshot1.png)
...
You can save your code in R scripts. (see figure 2 below)
You can write comments in your code using "`# `"

![Creating a new R-script in R studio](../../img/highres/copenhagen-screenshot2.png)
