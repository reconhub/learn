...
The first dataset we will be using has been modified from a dataset for 581 patients with acute meningitis (Table 1). Data from a subset of 422 patients were used to examine factors associated with differentiating between acute viral or acute bacterial meningitis^[Spanos A, Harrell FE, Durack DT. Differential diagnosis of acute meningitis: An analysis of the predictive value of initial observations. JAMA, 1989; 262: 2700-2707]. The original dataset can be found at: http://biostat.mc.vanderbilt.edu/wiki/Main/DataSets
...
|Variable Name|Variable Description                 |Type of Variable                     |Representation in R|
|-------------|-------------------------------------|-------------------------------------|-------------------|
|casenum      |Patient identification(id) number    |integer                              |`integer`          |
|year         |Year of admission (years since 1900) |integer                              |`integer`          |
|month        |Month of admission                   |integer                              |`integer`          |
|age          |Age in years                         |continuous                           |`numeric`          |
|race         |Race                                 |Binary, decimal: 1 = Black, 2 = White|`integer`          |
|sex          |Sex                                  |Binary, decimal: 0 = male, 1 = female|`integer`          |
|wbc          |White blood cell count               |continuous [count/1000]              |`numeric`          |
|bloodgl      |Blood glucose                        |continuous [mg/dl]                   |`integer`          |
|gl           |Cerebrospinal fluid (CFS) Glucose    |continuous [mg/dl]                   |`integer`          |
|pr           |CSF Protein                          |continuous [mg/dl]                   |`integer`          |
|whites       |Total leukocytes in CFS              |continuous [count/mm3]               |`integer`          |
|polys        |% Polymorphonuclear Leukocytes in CSF|continuous percentage                |`integer`          |
|abm          |Acute Bacterial Meningitis           |Binary, numeric: 0 = no, 1 = yes     |`integer`          |
...
addmargins(tab) # frequencies (summed over rows and columns)
...
|Group           |Number of Observations|Mean|Standard Deviation|Standard Error|95% CI            |
|----------------|----------------------|----|------------------|--------------|------------------|
|**Vaccinated**  |6185                  |3495|670               |8.519         |3478.299, 3511.701|
|**Unvaccinated**|18523                 |3510|639               |4.695         |3500.927, 3519.073|
...
|----------------|---------------------------------------------------------|---------------------------------------------------------------------|
|ID              |Unique identification number                             |numeric, missing=.                                                   |
|sex             |Sex of case                                              |Male, Female, missing=.                                              |
|postcode        |Postcode of place of usual residence                     |numeric, missing=.                                                   |
|birthdate       |Date of birth                                            |dd/mm/yyyy, missing=.                                                |
|age             |Age in Years (stated by case)                            |numeric                                                              |
|notificationdate|Date of notification (from laboratory or clinician)      |dd/mm/yyyy, missing=.                                                |
|onsetdate       |Date of illness onset (from case)                        |dd/mm/yyyy, missing=.                                                |
|howconfirmed    |Type of laboratory confirmation                          |4-digit code starting with P=PCR, starting with S=serology, missing=.|
|mother          |Mother unewll prior to illness onset                     |yes=1, no=0, missing=9                                               |
|father          |Father unewll prior to illness onset                     |yes=1, no=0, missing=9                                               |
|sibling         |Any sibling unewll prior to illness onset                |yes=1, no=0, missing=9                                               |
|spouse          |Spouse unewll prior to illness onset                     |yes=1, no=0, missing=9                                               |
|otherhousehold  |Any other household contact unewll prior to illness onset|yes=1, no=0, missing=9                                               |
|workplace       |Any workplace colleague unewll prior to illness onset    |yes=1, no=0, missing=9                                               |
