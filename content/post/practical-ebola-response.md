...
-   [`xlsx`](https://cran.r-project.org/web/packages/xlsx/index.html) to
    read `.xlsx` files
...
![](practical-ebola-response_files/figure-markdown_github/epicontacts_plot-1.png)
...
fixed value of $R\_0 = $1.81, the ML estimate of *R*<sub>0</sub>:
...
part](../simulated-evd-reconstruction) of this simulated response, which
