...
```{r stegen_hw_difficult-4, eval = FALSE}
stegen_data <- read.csv(here::here("data", "stegen_clean.csv"), stringsAsFactors = FALSE)

```{r stegen_hw_difficult-4.1, results = 'hide', echo = FALSE}
...
```{r stegen_hw_difficult-20, eval = FALSE}
...
```
```{r stegen_hw_difficult-20.1, echo = FALSE}
# This function needs to be saved in the same folder as the working directory
