...
```{r delays_in_reporting_answers, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r log_plot_snippet, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r n_weeks_to_remove_answer, echo = full_version}
# how many weeks should we discard at the end of the epicurve
...
```{r fit_truncated, echo = full_version}
...
```{r notes_growth_rate, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r epicontacts, echo = full_version}
...
```{r check_contact_cases, echo = full_version}
...
```{r superspreading_snippet, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r si_snippet, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r calc_R, echo = full_version, warning = FALSE}
...
```{r R_snippet, echo = FALSE, results = render_snippet, eval = full_version}  
...
```{r R_fix_within_explanation, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r projections2, echo = full_version}
...
```{r interpret_results_answers, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r R_snippet_proj, echo = FALSE, results = render_snippet, eval = full_version}
...
```{r timevarying_r, echo = full_version, warning = FALSE}
...
```{r timevarying_r_whole_incid, echo = full_version}
...
```{r Rt_plot, echo = FALSE, results = render_snippet, eval = full_version}
