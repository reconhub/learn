...
challenges. In this lecture, we outline tools which can help address some of
these challenges, and create more robust and efficient data analytics pipelines
using **R**.
