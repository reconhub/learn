...
This practical requires a working version of \Rlogo~ [@np145] greater than or
equal to 2.15.2.  It uses the following packages: *stats* implements basic
hierarchical clustering routines, *ade4* [@tj548] and *adegenet* [@tjart05] are
here used essentially for their graphics, *ape* [@tj527] is the core package for
phylogenetics, and *phangorn* [@tj843] implements parsimony and likelihood-based
...
implemented in *adegenet* [@tjart23].
...
details).  Here, we use Tamura and Nei 1993's model [@tj841] which allows
...
[@tj841] are probably fair choices.  At the very least, the genetic
...
More information about phylogenetic models can be found in [@tj842].
...
Nei's distance [tj841].  However, we can note that it is remarkably similar
