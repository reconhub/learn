...
```{r practical-vbd-4, include = FALSE}
# Parameters
...
```{r practical-vbd-6, include =FALSE}
arbovmodel <- function (t, x, params) {
...
```{r practical-vbd-8, include=FALSE}
# ----------- Solving the model
times  <- seq(1,365 * TIME , by = 1)
...
```{r practical-vbd-10, include=FALSE}
# Creating time options to display
out$years <- out$time / 365
out$weeks <- out$time / 7
```
