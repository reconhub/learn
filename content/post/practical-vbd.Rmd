...
In this section, run the model and try to understand and complete the arguments of the *ode* function in the *dsolve* package, and comment that part of the code.
