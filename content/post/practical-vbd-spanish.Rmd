...
En esta práctica, se comenzará por comprender los componentes que contribuyen a `$R_0$` y cómo las posibles intervenciones influyen en la transmisión. Más adelante, el participante debe construir un modelo de transmisión del Zika para observar los efectos de varios parámetros.
...
Cuando la instalación haya terminado, cargue los paquetes ingresando en R los siguientes comandos:
...
Contribuciones son bienvenidas vía [pull requests](https://github.com/reconhub/learn/pulls). El archivo fuente de este documento puede ser encontrado [**aquí**](https://raw.githubusercontent.com/reconhub/learn/master/content/post/practical-vbd.Rmd).
