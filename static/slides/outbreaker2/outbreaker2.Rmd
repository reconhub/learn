...
- <font color="#99004d">transmission tree</font>: directed acyclic graph representing transmission events
of an outbreak

- <font color="#99004d">transmission chain</font>: path from one case one descending case
