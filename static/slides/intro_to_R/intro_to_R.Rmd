...
## <font color="#99004d">Numbers</font>: `integer` and `numeric`
...
<center><img src="../../img/slides/function.png" width="35%"></center>
...
```{r}
rnorm(8, mean = 3, sd = 2) # this is not stored
toto <- rnorm(8, mean = 3, sd = 2) # store output in toto
toto
```
