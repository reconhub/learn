...
- Content on slides 5, 6, 7 and 12 adapted from Alex Spina ([link](https://appliedepi.github.io/emory_training/presentation/slides_workflow.html#6)).

- Minor edits by Thibaut Jombart.
...
## What is R? {.columns-2}
 ...
 - over 10,000 R packages
   - Easy to install `install.packages("incidence2")`
   - Easy to use `library("incidence2")`
<br>
<br>
<br>
<br>
...
<center>
<img src="../../img/slides/automation-win.png" width="65%">
<center>
