...
>- How many case should we expect in xxx days?
...
<center>
<img src="../../img/slides/generation-time.jpg" width="50%">
</center>
...
- find $\theta_x$ which maximise $p(x)$
...
- need to be <font color="#99004d">discretised</font>
...
<center>
<img src="../../img/slides/cfr.jpg" width="60%">
</center>
...
- standard error: 
$$
s_{CFR} = \sqrt{\frac{CFR (1 - CFR)}{N}}
$$
with $N = D + R$ (nb of cases with known outcomes)

- confidence interval with $\alpha$ threshold:
$$
CFR \pm s_{CFR} \times Q_{1-\alpha/2} 
$$
...
- not accounting for uncertainty, e.g. comparing CFR across groups without
  statistical tests
...
**Definition (reminder):** time interval between <font color="#99004d">onset of
