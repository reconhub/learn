...
1. a `.Rmd` post in `content/post` (see above) to introduce the lecture and link to the slides
...
`blogdown::serve_site()`. For an example, look at the content of
`static/slides/intro_reproducibility_Rmd/`.
