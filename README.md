...
existing one and rename it. The name must:

- include the date in the format `yyyy-mm-dd` as prefix
- be explicit
- use `-` as separator
...
tags: ["Rmarkdown", "phylogenetics", "genetics"]
date: 2017-11-01T14:00:00-00:00
image: img/highres/logs.jpg
showonlyimage: true
...
`content/post/2017-11-10-lecture-reproducibility.Rmd`.
...
`blogdown::serve_site()`. For an example, look at
